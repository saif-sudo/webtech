		...
		<div class = "account">
			...
			<h1 style="text-align:center">Teacher Registration</h1>
...
<?php  
 ...
 {  
      if(empty($_POST["sid"]))  
      {  
           $error = "<label class='text-danger'>Enter Teacher ID</label>";  
      }
      ...
      {  
           $error = "<label class='text-danger'>Enter a Teacher Salary</label>";  
      }
      ...
      {  
           if(file_exists('tr.json'))  
           {  
                $current_data = file_get_contents('tr.json');  
                ...
                if(file_put_contents('tr.json', $final_data))  
                {  
