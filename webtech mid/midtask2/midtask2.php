...
<?php
$name = $email = $date = $dd= $mm=$yyyy=$gender=$degree= $bg="";
...
<input type="text" name="name" value="" ><span class="error">* <?php echo $nameE;?> </span><br>
...
<input type="text" name="email" value=""><span class="error">* <?php echo $emailE;?></span><br>
<hr style="border: 0.1px solid;">
